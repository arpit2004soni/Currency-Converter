#installed packege from pip installer for currency rates
#installed from commandprompt
from currency_converter import CurrencyConverter
#tkinter for Graphical user interface command
...
#function for clicking button to generate output
def clicked():
    amount=int(e1.get())
    cur1=e2.get()
    cur2=e3.get()
...
#these are font sizes their place and all its representation
...
#creating main loop to generate output by compiling terms
window.mainloop()
